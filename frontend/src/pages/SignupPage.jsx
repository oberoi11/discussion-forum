    ...
    >
      ...
      <div style={{ width: "100%", maxWidth: 1200 }}>
        <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 12 }}>
          ...
          >
            {isDark ? <MdLightMode size={22} color={theme.accent} /> : <MdDarkMode size={22} color={theme.accent} />}
          </button>
        </div>
            ...
            >
              ...
              <form onSubmit={(e) => e.preventDefault()} style={{ display: "grid", gap: 16 }}>
                ...
                <p style={{ textAlign: "center", color: theme.textSecondary, marginTop: 6 }}>
                  ...
                  <button onClick={() => navigate("/login")} style={{ color: theme.accent, background: "none", border: "none", fontWeight: 700 }}>
                    Sign In
                  </button>
                </p>
              </form>
